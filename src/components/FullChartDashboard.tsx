...
// console.log("dosage", data.dosage);
        ...
        chart: {
          events: {
            load: function () {
              ...
              const iit_prediction = document.getElementById('iit_prediction');
              if (iit_prediction) {
                ...
                iit_prediction.innerText = iitprediction+"%";
              }
            }
              //Get and set the iit_last_12_mnths
              const iit_last_12_mnths = document.getElementById('iit_last_12_mnths');
              if (iit_last_12_mnths) {iit_last_12_mnths.innerText = chartData.iit_last_12_mnths; }
  ...
  return <div>
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', marginBottom: '1rem' }}>
      <div style={{ flex: 1, textAlign: 'center'}} className={styles.patientFlags} id="apptcompliance">Appointment Compliance <span id="lastdrugpickup" className={styles.lastdrugpickup}></span></div>
      <div style={{ flex: 1}} className={styles.patientFlags} id="vlflagbg">Current Viral Status <span id="vlflag" className={styles.vlflag}></span></div>
      <div style={{ flex: 1, textAlign: 'center'}} className={styles.patientFlags} id="dateEligibleVLbg">Date Eligible for Viral Laod <span id="dateEligibleVL" className={styles.dateEligibleVL}></span></div>
      <div style={{ flex: 1, textAlign: 'center'}} className={styles.patientFlags} id="bloodsugarbg">Blood Sugar <span id="bloodsugar" className={styles.bloodsugar}></span></div>
    </div>
    <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', marginBottom: '1rem' }}>
      <div style={{ flex: 1, textAlign: 'center'}} className={styles.patientFlags} id="bloodpressurebg">Blood Pressure <span id="bloodpressure" className={styles.bloodpressure}></span></div>
      <div style={{ flex: 1, textAlign: 'center'}} className={styles.patientFlags} id="tbstatusbg">TB Status <span id="tbstatus" className={styles.tbstatus}> N/A</span></div>
      <div style={{ flex: 1, textAlign: 'center'}} className={styles.patientFlags} id="meningitisstatusbg">Cryptococcal Meningitis status <span id="meningitisstatus" className={styles.meningitisstatus}> N/A</span></div>
      <div style={{ flex: 1, textAlign: 'center'}} className={styles.patientFlags} id="biomtetricstatusbg">Finger print captured <span id="biomtetricstatus" className={styles.biomtetricstatus}></span></div>
    </div>

    <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', marginBottom: '1rem' }}>
      <div style={{ flex: 1, textAlign: 'center', backgroundColor: 'rgb(3, 49, 34)',color:'#fff', margin: '10px 5px',padding: '0.25em 0.4em', borderRadius: '0.25rem',fontSize:'75%',fontWeight:'700' }}>ART Start Date <div id="art_initiation">00-00-0000</div></div>
      <div  style={{ flex: 1, textAlign: 'center', backgroundColor: 'rgb(3, 49, 34)',color:'#fff', margin: '10px 5px',padding: '0.25em 0.4em', borderRadius: '0.25rem',fontSize:'75%',fontWeight:'700' }}>No. IIT in the last 12 months <div id="iit_last_12_mnths">0</div></div>
      <div  style={{ flex: 1, textAlign: 'center', backgroundColor: 'rgb(3, 49, 34)',color:'#fff', margin: '10px 5px',padding: '0.25em 0.4em', borderRadius: '0.25rem',fontSize:'75%',fontWeight:'700' }}>Duration of last IIT  <div id="last_iit">0 days</div></div>
      <div  style={{ flex: 1, textAlign: 'center', backgroundColor: 'rgb(3, 49, 34)',color:'#fff', margin: '10px 5px',padding: '0.25em 0.4em', borderRadius: '0.25rem',fontSize:'75%',fontWeight:'700' }}>Time Since last IIT <div id="time_since_last_iit">0 days</div></div>
      <div  style={{ flex: 1, textAlign: 'center', backgroundColor: 'rgb(3, 49, 34)',color:'#fff', margin: '10px 5px',padding: '0.25em 0.4em', borderRadius: '0.25rem',fontSize:'75%',fontWeight:'700' }}>IIT Total <div id="iit_total">0</div></div>
      <div  style={{ flex: 1, textAlign: 'center', backgroundColor: '#ddd',color:'#333', margin: '10px 5px',padding: '0.25em 0.4em', borderRadius: '0.25rem',fontSize:'75%',fontWeight:'700' }}>IIT Prediction <div id="iit_prediction">0%</div></div>
    </div>
    <div id="loadingGifdiv" style={{ textAlign:'center'}}><img id="loadingGif" src={loadingImage} width={50} height={50} /></div>
